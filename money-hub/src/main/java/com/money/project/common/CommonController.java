package com.money.project.common;
...
import com.money.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("file name({})Illegal, download not allowed。 ", fileName));
            }
            ...
            throws Exception
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("file name({})Illegal, download not allowed。 ", resource));
            }
